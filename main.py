...
if __name__ == "__main__":
    ...
    args.train_data = './data/scenario/train_0.9_TUP.txt'
    args.train_frames = './data/scenario/train_0.9_frame.txt'

    args.valid_data = './data/scenario/valid_0.9_TUP.txt'
    args.valid_frames = './data/scenario/valid_0.9_frame.txt'

    args.test_data = './data/scenario/test_0.9_TUP.txt'
    ...
    args.frame_vocab_ref = './data/scenario/vocab_frame_all.pickle'
