...
def monolithic_compute_loss(iteration, model, target, target_lens, latent_values, latent_root, diff, dec_outputs, use_cuda, args, train=True, topics_dict=None, real_sentence=None, next_frames_dict=None, word_to_frame=None, show=False, base_layer=True):
    """
...
def run_models(models, batch, batch_lens, target, target_lens, f_vals, f_ref, vocab, vocab2, iteration, use_cuda=True, train=True, args=None):
    ...
    for i, model in enumerate(models):
        ...
        loss, ce_loss = monolithic_compute_loss(iteration, model, target, target_lens, latent_values, latent_root,
                                        ...
                                        word_to_frame=word_to_frame, train=train, show=True, base_layer=base_layer)
