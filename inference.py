...
from show_inf import run
from cloze_utils import find_file
...
if __name__ == "__main__":
    ...
    config_prefix= '/p/work/sroydip1/saved_configs/'
    model_prefix = '/p/work/sroydip1/saved_models/'
    config_prefix = './saved_configs/'
    model_prefix = './saved_models/'
    config_address = config_prefix + 'chain__emb_size_300_nlayers_2_lr_0.001_batch_size_512_seed_{}_bidir_True_num_latent_values_500_latent_dim_500_dropout_0.0_num_clauses_5_obsv_prob_{}_template_20_exp_num_{}_num_of_models_2_num_of_children_5 3.pkl'.format(str(args.seed),str(args.obsv_prob),str(args.exp_num))
    
    config_postfix = find_file(f'exp_num_{str(args.exp_num)}_', config_prefix)
    config_address = config_prefix + config_postfix
    experiment_name = 'nyt_{}_{}_eps_{}_num_{}_seed_{}'.format('chain_event_',str(args.data_mode),str(args.obsv_prob),str(args.exp_num),str(args.seed))
    ...
    with open(config_address, 'rb') as f:
        ...
        # model_postfix = 'chain__emb_size_300_nlayers_2_lr_0.001_batch_size_512_seed_{}_bidir_True_num_latent_values_500_latent_dim_500_use_pretrained_True_dropout_0.0_num_clauses_5_obsv_prob_{}_exp_num_{}_num_of_models_{}_num_of_children_{}.pt'.format(str(args.seed), str(args.obsv_prob), str(args.exp_num), str(args_dict['num_of_models']), str(args_dict['num_of_children']))
        # model_postfix = 'chain__emb_size_300_nlayers_2_lr_0.001_batch_size_512_seed_{}_bidir_True_num_latent_values_500_latent_dim_500_dropout_0.0_num_clauses_5_obsv_prob_{}_template_20_exp_num_{}_num_of_models_{}_num_of_children_{}.pt'.format(str(args.seed), str(args.obsv_prob), str(args.exp_num), str(args_dict['num_of_models']), str(args_dict['num_of_children']))
        model_postfix = config_postfix[:-3] + 'pt'
        
        args.num_of_models = int(args_dict['num_of_models'])
        args.num_of_children = args_dict['num_of_children']
